...
-- 1. Insert dummy users (password: 'password123' hashed using BCrypt: $2a$10$dMsw2aFq/K/2r1B7K1x7k.wJ0B.f8v5f3uXzQ/8R07B/q2q3j9WqS)
...
-- student1: 내신 1.8등급, 수능 국어 125, 수학 130, 영어 2, 탐구1 60, 탐구2 62 (표준점수 기준)
-- student2: 내신 1.1등급, 수능 국어 138, 수학 145, 영어 1, 탐구1 70, 탐구2 68 (의대 적합 성적)
...
('서강대학교', '서울', 'https://upload.wikimedia.org/wikipedia/commons/6/6f/Sogang_University_seal.svg', 'https://www.sogang.ac.kr', '예수회 교육념에 기초하여 지성과 인성을 겸비한 전인교육을 실시합니다.'),
